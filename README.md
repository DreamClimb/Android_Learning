# Java_Android_Learning

积累一些 Java、Android 学习笔记以及一些优秀文章，加强自己的同时希望也能帮到大家！

### [Java 基础](recollect)

* [基础知识点](recollect/重拾Java（0）-基础知识点.md)
* [基本数据类型与字面值](recollect/重拾Java（1）-基本数据类型与字面值.md)
* [运算符](recollect/重拾Java（2）-运算符.md)
* [异常处理](recollect/重拾Java（3）-异常处理.md)
* [线程](recollect/重拾Java（4）-线程.md)
* [枚举](recollect/重拾Java（5）-枚举.md)
* [注解](recollect/重拾Java（6）-注解.md)
* [泛型](recollect/重拾Java（7）-泛型.md)
...
- [《深入理解Java虚拟机》笔记4——类文件结构](https://meandni.com/2019/01/14/jvm_note4/)
- [《深入理解Java虚拟机》笔记5——类加载机制与字节码执行引擎](https://meandni.com/2019/01/15/jvm_note5/)
